...
INSERT INTO Beer VALUES (3, 'Brandywine Brawler', 5, 'By Yards Brewing', 0, 4.2, NULL, '2017-10-27', NULL)
...
INSERT INTO Beer VALUES (3, 'Love Stout', 23, 'Our brewers have poured their hearts and roasted malts into this rich, slightly sweet stout. Luscious notes of coffee and chocolate accent the smooth, creamy mouth feel. We will not apologize for any amorous affairs resulting from the consumption of this beverage. By Yards Brewing', 0, 5.5, 21, '2010-08-21', NULL)
INSERT INTO Beer VALUES (3, 'Philadelphia Pale Ale', 18, 'Not to be boastful, but we honestly believe all other ales pale in comparison to ours. Dry hopped with an abundance of distinctive Simcoe hops, this straw colored pale ale is more drinkable than bitter, more aromatic than aggressive. Philly Pale, as it’s better known, is crisp, hoppy, and bursting with citrus. By Yards Brewing', 0, 4.6, 37, '2010-08-21', NULL)
INSERT INTO Beer VALUES (3, 'Poor Richards Spruce', 2, 'Based on Franklin’s original recipe, which called for barley, molasses, and essence of spruce, our Tavern Spruce is as approachable and engaging as was the man himself. We source blue spruce clippings from a local organic farmer, steeping them in the kettle to create this one-of-a-kind deep amber ale. By Yards Brewing', 0, 5, 13, '2010-08-21', NULL)
...
INSERT INTO Beer VALUES (3, 'Rival IPA', 13, 'This is Rival IPA and it is an “over the top” ale that uses pale crystal and rye malts. This beer also uses Bravo, Nugget and whole flower Chinook hops (in the hopback). If that’s not enough fun, Rival is then dry-hopped with Centennial, Citra, Simcoe and Columbus hops. By Yards Brewing', 0, 6.2, 65, '2016-09-17', NULL)
INSERT INTO Beer VALUES (3, 'Thomas Jefferson''s Tavern Ale', 5, 'This powerful and complex golden ale pays homage to Founding Father and fellow brewer, Thomas Jefferson. Yards Brewmaster, Tom Kehoe, worked closely with Philadelphia’s historic City Tavern to recreate this recipe, employing honey, rye, and wheat, just like the beer Jefferson made at Monticello. By Yards Brewing', 0, 8, 28, '2010-08-21', NULL)
